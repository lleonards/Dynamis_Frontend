...
import { Plug, ArrowLeft, Save, Trash2, Info, Pencil, PlusCircle, Layers3 } from 'lucide-react';
...
export default function CalcTomadas() {
  ...
  const handleSave = () => {
    ...
    const label = buildLabel(form, entries.length);
  ...
  const handleClearAll = () => {
    ...
    refreshEntries();
    resetCurrent();
    toast.success('Todos os registros de tomadas foram removidos.');
  };
    ...
    <div style={{ maxWidth: '980px', margin: '0 auto', padding: '32px 24px' }}>
      ...
      <div className="card" style={{ marginBottom: '18px' }}>
        <div className="notice-box" style={{ marginBottom: '20px' }}>
          <Info size={16} />
          <span>Salvar não consome crédito. O consumo acontece apenas ao gerar o projeto na tela inicial. Esta ferramenta está sem limite de registros.</span>
        </div>
