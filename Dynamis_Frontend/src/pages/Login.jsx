...
import { Eye, EyeOff, LogIn, HelpCircle, ShieldCheck } from 'lucide-react';
      ...
      <div className="auth-center-wrap">
        <section className="card auth-card auth-card-minimal">
          ...
          <p className="auth-form-subtitle auth-form-subtitle-compact">
            Entre para continuar usando suas ferramentas e gerar resultados com base nas normas aplicáveis.
          </p>
