  ...
  return (
    <div style={{ minHeight: '100vh', background: 'radial-gradient(ellipse at top, #141428 0%, #0d0d0f 60%)', display: 'flex', alignItems: 'center', justifyContent: 'center', padding: '24px' }}>
      <div style={{ width: '100%', maxWidth: '420px' }}>
        ...
        <div className="card">
          <h2 style={{ fontSize: '1.3rem', fontWeight: '700', marginBottom: '24px', textAlign: 'center' }}>Entrar na sua conta</h2>
          ...
          <div style={{ textAlign: 'center', marginTop: '20px', borderTop: '1px solid #2a2a38', paddingTop: '20px' }}>
            <p style={{ color: '#606070', fontSize: '0.9rem' }}>
              Não tem conta? <Link to="/register" style={{ color: '#6ba3cc', textDecoration: 'none', fontWeight: '600' }}>Criar conta grátis</Link>
            </p>
          </div>
        </div>

        <p style={{ textAlign: 'center', marginTop: '16px', color: '#3a3a50', fontSize: '0.78rem' }}>
          🎁 Novos usuários ganham 3 créditos grátis para gerar projetos.
        </p>
      </div>
    </div>
  );
