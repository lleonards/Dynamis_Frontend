...
import { Cable, ArrowLeft, Save, Trash2, Info, Pencil, PlusCircle, Layers3 } from 'lucide-react';
...
export default function CalcCondutores() {
  ...
  const handleSave = () => {
    ...
    saveToolEntry('condutores', form, buildLabel(form, entries.length), editingId);
    refreshEntries();
    resetCurrent();
