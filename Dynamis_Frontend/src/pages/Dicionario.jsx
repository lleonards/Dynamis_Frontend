...
export default function Dicionario() {
  ...
  const handleCarregar = async () => {
    ...
    try {
      ...
      toast.error('Erro ao carregar dicionario.');
    } finally {
      setLoading(false);
    }
  };
  ...
  return (
    <div style={{ maxWidth: '800px', margin: '0 auto', padding: '32px 24px' }}>
      ...
      <div style={{ display: 'flex', alignItems: 'center', gap: '12px', marginBottom: '28px' }}>
        ...
        <div>
          <h1 style={{ fontSize: '1.4rem', fontWeight: '700' }}>Dicionario Tecnico Eletrico</h1>
          <p style={{ color: '#606070', fontSize: '0.85rem' }}>25+ termos tecnicos com definicoes completas</p>
        </div>
      </div>
      ...
      {!carregado ? (
        <div className="card" style={{ textAlign: 'center', padding: '40px' }}>
          ...
          <p style={{ color: '#606070', marginBottom: '20px' }}>Clique para carregar o dicionario tecnico completo</p>
          <button onClick={handleCarregar} className="btn-primary" disabled={loading} style={{ margin: '0 auto' }}>
            ...
            {loading ? 'Carregando...' : 'Abrir dicionario'}
          </button>
        ...
        <div>
          <div style={{ position: 'relative', marginBottom: '20px' }}>
            ...
            <input
              ...
              placeholder="Buscar termo ou definicao..."
              value={busca}
          ...
          <div style={{ display: 'flex', flexDirection: 'column', gap: '8px' }}>
            {termosFiltrados.map((t, i) => (
              <div key={i} style={{
                background: '#141418', border: '1px solid #2a2a38', borderRadius: '10px', padding: '16px',
                borderLeft: '3px solid #b87eb8'
              }}>
