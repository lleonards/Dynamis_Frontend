...
import { Zap, ArrowLeft, Save, Trash2, Info, Pencil, PlusCircle, Layers3 } from 'lucide-react';
...
export default function CalcPadrao() {
  ...
  const handleSave = () => {
    ...
    saveToolEntry('padraoEntrada', form, buildLabel(form, entries.length), editingId);
    refreshEntries();
    resetCurrent();
